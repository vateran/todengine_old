...
//-----------------------------------------------------------------------------
inline bool operator == (const String& s1, const char_t* s2)
{
    return s1.data_ == s2;
}
...
//-----------------------------------------------------------------------------
inline bool operator == (const char_t* s1, const String& s2)
{
    return s2.data_ == s1;
}
...
//-----------------------------------------------------------------------------
inline tod::String operator + (const String& s1, const String& s2)
{
    String r(s1);
    r += s2;
    return r;
...
//-----------------------------------------------------------------------------
inline tod::String operator + (const String& s1, const char_t* s2)
{
    String r(s1);
    r += s2;
    return r;
...
//-----------------------------------------------------------------------------
inline tod::String operator + (const char_t* s1, const String& s2)
{
    String r(s1);
    r += s2;
    return r;
